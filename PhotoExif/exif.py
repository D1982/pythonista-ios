...
def set_ref_location(sender): # DOtt
  '''Get the geo location from the reference photo and apply it to the other photos as well
  '''
  if assets[0].can_edit_properties == true:
    loc = assets[0].location
